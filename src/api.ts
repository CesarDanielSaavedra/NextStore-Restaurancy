...
const api = {
  // URL de la GoogleSheet donde tenemos la data a modo de ejemplo
  sheetUrl:
    "https://docs.google.com/spreadsheets/d/e/2PACX-1vRJf6UQzOwPaT7NSc4cmqXv0wEaON5b7W4LEvE9DZYaQ5hNqXuLSZ7aCumkriRSbpPt0uJla4Qvfhlp/pub?output=csv",
  ...
  list: async (): Promise<Restaurant[]> => {
    ...
    const [, ...data] = await fetch("https://docs.google.com/spreadsheets/d/e/2PACX-1vRJf6UQzOwPaT7NSc4cmqXv0wEaON5b7W4LEvE9DZYaQ5hNqXuLSZ7aCumkriRSbpPt0uJla4Qvfhlp/pub?output=csv").then(res => res.text()).then(text => text.split('\n'))
  ...
  // list2: async (): Promise<Restaurant[]> => {
  //   // Simular un delay en la respuesta de la API
  //   await sleep(400);
  ...
  // fetch2: async (id: Restaurant["id"]): Promise<Restaurant> => {
  //   // Simular un delay en la respuesta de la API
  //   await sleep(400);
